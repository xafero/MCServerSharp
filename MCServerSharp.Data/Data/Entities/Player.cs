...
namespace MCServerSharp.Data.Entities {
	public class Player : Entity {
		...
		/// </summary>
		public readonly INetworkClient Network;
		/// <summary>
		...
		public Player(string name, UUID uuid, INetworkClient network) : base(uuid) {
			AccountName = name;
			DisplayName = name;
			Network = network;
		}

		public override bool IsOp => Global.ServerInstance.IsOperator(Uuid);
