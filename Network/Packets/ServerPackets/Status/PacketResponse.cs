	...
	public class PacketResponse : IServerPacket {
		...
		public PacketResponse(string? JSONResponse) {
			if (JSONResponse is null) {
				...
				this.JSONResponse = GenerateText(server.GameVersion, IPacket.LastestProtocolVersion, server.ServerOptions.MaxPlayers, server.Players.Count, Array.Empty<string>(), "Powered By MCServerSharp", server.ServerIconBase64);
			} else
